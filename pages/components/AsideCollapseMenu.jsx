...
const AsideCollapseMenu = () => {
  const match_mq__minWith_768 = useMediaQuery("(max-width:768px)");

  const [isActive, setIsActive] = useState("Vista general");

  const [isCollapse, setIsCollapse] = useState(match_mq__minWith_768);

  useEffect(() => {
    setIsCollapse(match_mq__minWith_768);
  }, [match_mq__minWith_768]);
  ...
  return (
    ...
    >
      <div
        className={`aside__head ${isCollapse ? "aside__head--collapsed" : ""}`}
      >
        <img
